...
struct QuizPhotoCard: View {
    ...
    /// Fixed aspect ratio (width/height). When set, card maintains this ratio in both compact and non-compact layouts.
    ...
    private var cardHeight: CGFloat { preferredHeight ?? 280 }
