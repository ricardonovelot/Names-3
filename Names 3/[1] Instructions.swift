/*
 ...
 - Media/Graphics: AVFoundation best practices, AVPlayerLayer over heavy abstractions, prefetching, buffer policy tuning.
 ...
 - Do not contradict sections above. If a new rule refines an existing one, update the existing line instead of adding a duplicate.
